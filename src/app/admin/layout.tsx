      ...
      <header className="bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <span className="text-gray-400 dark:text-gray-500 text-xs">管理画面</span>
          </div>
          <nav className="flex items-center gap-4 text-sm">
            ...
            <Link href={routes.home} className="text-gray-400 hover:text-white dark:text-gray-500 dark:hover:text-gray-900 text-xs transition-colors">
              ← サイトへ戻る
            </Link>
          </nav>
        </div>
