...
const REASONS = [
  ...
  },
  {
    ...
    why: "画面と DB の間にサーバーを別立てすると、型を両側で持ち直すことになり、認可を確認すべき入口も増える。Next.js は画面を作るコード自体がサーバーで動く（サーバーコンポーネント）ので、画面に出すデータを DB から直に取れる。HTTP の受け口（Route Handler）を置くのは外部から呼ばれるものだけで済む。",
  },
  {
